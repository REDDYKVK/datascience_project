...
def get_pie_chart(entered_site):
    if(entered_site == 'All'):
        ...
        return px.pie(filtered_df, values='class', names='Launch Site', title='Total Success Launches by All Sites')
    # return the outcomes in pie chart for a selected site
        ...
        return px.pie(filtered_df, values='counts', names='outcome', title='Total Success Launches by site '+ entered_site)
